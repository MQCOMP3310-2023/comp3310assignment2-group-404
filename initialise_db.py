...
def populate_db():
    ...
    restaurant1 = Restaurant(name = "Urban Burger", owner_id = 1)
    ...
    restaurant2 = Restaurant(name = "Super Stir Fry", owner_id = 2)
    ...
    restaurant1 = Restaurant(name = "Panda Garden", owner_id = 3)
    ...
    restaurant1 = Restaurant(name = "Thyme for That Vegetarian Cuisine ", owner_id = 4)
    session.add(restaurant1)
    session.commit()
    ...
    restaurant1 = Restaurant(name = "Tony\'s Bistro " , owner_id = 5)
    session.add(restaurant1)
    session.commit()
    ...
    #Menu for Andala's 
    restaurant1 = Restaurant(name = "Andala\'s" , owner_id = 6)
    session.add(restaurant1)
    session.commit()
    ...
    restaurant1 = Restaurant(name = "Auntie Ann\'s Diner " , owner_id = 6)
    session.add(restaurant1)
    session.commit()
    ...
    restaurant1 = Restaurant(name = "Cocina Y Amor " , owner_id = 6)
    session.add(restaurant1)
    session.commit()
